...
class TestPluginFactory:
    ...
    def test_create_instance_when_context_empty(
        self, mock_get_plugin_attribute, mock_importlib
    ):
        ...
        mock_get_plugin_attribute.assert_called_once_with(
    ...
    def test_get_plugin_attribute(self):
        ...
        assert mock_module.MockPlugin == PluginFactory._get_plugin_attribute(
            module=mock_module
        )
