...
latex_documents = [
  ('index', 'ivory.tex', u'ivory workflow engine Documentation',
...
man_pages = [
    ('index', 'ivory', u'ivory workflow engine Documentation',
     [u'Joel Akeret'], 1)
]
...
texinfo_documents = [
  ('index', 'ivory', u'Ivory workflow engine Documentation',
   u'Amadeus Wild', 'ivory', 'One line description of project.',
   'Miscellaneous'),
]
