...
from ivory.utils.opt_helper import get_all_longopts, get_opt_parameter_dict, get_section_parameter_name_from_opt


class TestOptHelper:
    def test_get_all_longopts(self):
        mock_config_sections = {"Section": ConfigSection(a=1)}
